module.exports = {
  parserOptions: {
    // 与最新的 LTS 版本的 Node.js 所支持的 ES 版本保持同步
    // 在 https://node.green/ 可以查看详情
    ecmaVersion: 8 /* = 2017 */,
    sourceType: 'module',
  },
  ...
  rules: {
    ...
    // 强制使用一致的大括号使用约定，单行时允许隐藏大括号，多行时必须使用大括号
    ...
    // 禁用 `with` 语句
    'no-with': 'error',
    // 要求使用 Error 对象作为 Promise reject 的原因
    ...
    // 禁止使用这种语法：`import { default as foo } from './foo.js'`
